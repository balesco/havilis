            ...
            <div id="large-consultats-slide" className="mx-1 carousel slide lg-slide" data-ride="carousel">
                <div className="carousel-inner px-3">
                    <div className="carousel-item shadow-none active" data-interval="60000">
                        <div className="row">
                            <div className="col-lg px-2">
                                <Formation img={eh} name="Hacking Éthique : Maîtrisez les techniques de base" teacher="Hervé Kenfack" fee="13.99" />
                            </div>
                            <div className="col-lg px-2">
                                <Formation img={dw} name="Développeur Web: Formation complète" teacher="Dominique Lanoix" fee="11.99" />
                            </div>
                            <div className="col-lg px-2">
                                <Formation img={ia} name="Intelligence Artificielle de A à Z" teacher="François Bayegle" fee="10" />
                            </div>
                            <div className="col-lg px-2">
                                <Formation img={wp} name="Créez son site internet avec WordPress - Initiation" teacher="William Kathleen" fee="24.99" />
                            </div>
                            <div className="col-lg px-2">
                                <Formation img={gc} name="Gestion des conflits avec confiance et élégance" teacher="Parfait Mombo" fee="11.99" />
                            </div>
                        </div>
                    </div>
                    <div className="carousel-item shadow-none" data-interval="60000">
                        <div className="row">
                            <div className="col-lg px-2">
                                <Formation img={seo} name="Développer son trafic grâce au référencement naturel SEO" teacher="Giovani Gali" fee="17.99" />
                            </div>
                            <div className="col-lg px-2">
                                <Formation img={vf} name="Developpez vos ventes avec Facebook" teacher="Boris Nonga" fee="25" />
                            </div>
                            <div className="col-lg px-2">
                                <Formation img={af} name="After Effects CC: Formation Complète" teacher="Idris Djeukemnang" fee="50" />
                            </div>
                            <div className="col-lg px-2">
                                <Formation img={pp} name="Devenez photographe portraitiste professionnel" teacher="Michel Ngassa" fee="19.99" />
                            </div>
                            <div className="col-lg px-2">
                                <Formation img={ssl} name="Social Selling: Prospectez et vendre avec LinkedIn" teacher="Stephane Eteme" fee="14.99" />
                            </div>
                        </div>
                    </div>
                </div>
